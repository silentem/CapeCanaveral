...
import kotlinx.android.synthetic.main.activity_launch_mode_single_top.*
import org.jetbrains.anko.info


class LaunchModeSingleTopActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            startActivity(Intent(this, LaunchModeSingleTopActivity::class.java).apply {
